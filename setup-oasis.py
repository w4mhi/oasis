...
FEATURES = [
    ...
    Feature("kiosk-7inch", "Kiosk mode — 7″ touchscreen (BigTreeTech / 800×480)", "enable-autostart-pi.py",
            "Auto-start the server and launch the 7″ touchscreen layout (/small-screen/index7.html, 800×480) in Chromium with touch enabled. For the BigTreeTech 7″ panel (the reference display) or any 800×480 touchscreen. Alternative to the fullscreen kiosk above. Raspberry Pi OS with Desktop. Tip: the BigTreeTech panel also has an onboard RTC — see the 'BigTreeTech 7″ RTC (PCF8563)' item.",
            "Display", default=False, needs=["server"], args=["--7inch"],
            recommend="7″ kiosk set up — reboot to see the touchscreen layout on the local screen."),
