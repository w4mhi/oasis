...
FEATURES = [
    ...
    Feature("kiosk-7inch", "Kiosk mode — 7″ touchscreen (800×480)", "enable-autostart-pi.py",
            "Auto-start the server and launch the 7″ touchscreen layout (/small-screen/index7.html, 800×480) in Chromium with touch enabled. Alternative to the fullscreen kiosk above. Raspberry Pi OS with Desktop.",
