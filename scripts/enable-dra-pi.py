...
Usage:
  python3 scripts/enable-dra-pi.py            # auto-detect the phase
  python3 scripts/enable-dra-pi.py --dry-run   # preview the config.txt changes
  python3 scripts/enable-dra-pi.py --config-only
  python3 scripts/enable-dra-pi.py --mixer-only
...
def do_mixer_phase():
    ...
    if not card_present():
        ...
        _info("  python3 scripts/enable-dra-pi.py --config-only")
        return 1
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=("Examples:\n"
                "  python3 scripts/enable-dra-pi.py             # auto-detect phase\n"
                "  python3 scripts/enable-dra-pi.py --dry-run   # preview config.txt edits\n"),
    )
