...
Usage:
  python3 scripts/install-fcc-database.py              # steps 1 + 2 + 3
  python3 scripts/install-fcc-database.py --full-zip   # force refresh zipcodes.csv
  python3 scripts/install-fcc-database.py --index-only # re-index from existing EN.dat
  python3 scripts/install-fcc-database.py --help
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python3 scripts/install-fcc-database.py                  # download FCC + index + ZIP table\n"
            "  python3 scripts/install-fcc-database.py --index-only     # re-index from existing EN.dat\n"
            "  python3 scripts/install-fcc-database.py --full-zip       # force refresh zipcodes.csv\n"
        ),
    )
