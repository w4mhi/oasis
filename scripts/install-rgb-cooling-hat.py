...
Usage:
  ...
  python3 scripts/install-rgb-cooling-hat.py --user pi  # service runs as 'pi'
  python3 scripts/install-rgb-cooling-hat.py --no-enable
  python3 scripts/install-rgb-cooling-hat.py --check    # report status
  python3 scripts/install-rgb-cooling-hat.py --disable  # remove service + daemon
...
SCRIPT_SRC   = os.path.join(REPO_ROOT, "rgb-cooling-hat", "rgb-cooling-hat.py")
...
def run(args):
    ...
    _info("Undo with: python3 scripts/install-rgb-cooling-hat.py --disable")
    print()
...
def main():
    ap = argparse.ArgumentParser(
        ...
        epilog=("Examples:\n"
                "  python3 scripts/install-rgb-cooling-hat.py\n"
                "  python3 scripts/install-rgb-cooling-hat.py --user pi\n"
                "  python3 scripts/install-rgb-cooling-hat.py --no-enable\n"
                "  python3 scripts/install-rgb-cooling-hat.py --check\n"
                "  python3 scripts/install-rgb-cooling-hat.py --disable\n"),
    )
