...
def step_check_overlays(overlay_dir):
    ...
    if not os.path.exists(m5_dtbo):
        _fail(
            "m5stack-cm4.dtbo not found in " + overlay_dir + ".\n\n"
            "  This overlay is a prebuilt binary from M5Stack and cannot be\n"
            "  generated by this script. Obtain it from:\n\n"
            "    git clone https://github.com/m5stack/m5stack-linux-dtoverlays\n"
            "    cd m5stack-linux-dtoverlays\n"
            "    make\n"
            "    sudo cp overlays/m5stack-cm4.dtbo " + overlay_dir + "/\n\n"
