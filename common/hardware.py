...
def startable_units(inv, service):
    """The units a generic starter (the console) can actually act on.

    Distinct from service_units(): a service whose only unit is synthetic has
    NOTHING to start from outside — for satellites the recorder is an ad-hoc
