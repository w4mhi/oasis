...
TNC_CONF_NAME = "direwolf-draws.conf"
...
# reinstall.
#
#   CHANNEL 0  ->  LEFT  mDin6  ->  APRS     ->  PTT BCM 12  (sysfs {ptt_left})
#   CHANNEL 1  ->  RIGHT mDin6  ->  Winlink  ->  PTT BCM 23  (sysfs {ptt_right})
#
# Apps attach over the shared AGW/KISS ports and pick their port by channel:
#   APRS   -> AGW 127.0.0.1:{agw}  radio_port 0
#   pat/RF -> AGW 127.0.0.1:{agw}  radio_port 1
...
# oasis-winlink.conf). Per-station opt-out: 'V20 <call>'.
MAXV22 0
...
def build_tnc_service(user, home, ptt_left, ptt_right):
    ...
    return """\
[Unit]
Description=OASIS DRAWS go-box TNC (direwolf, both radio ports)
