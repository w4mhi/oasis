...
def write_direwolf_config(callsign, adevice, ptt_gpio):
    ...
    conf = f"""# OASIS — Winlink RF modem (Direwolf). Generated by services/winlink/install.py.
...
# Generated by services/winlink/install.py. Pat reaches this over AGWPE at 127.0.0.1:{MODEM_AGW_PORT}.
