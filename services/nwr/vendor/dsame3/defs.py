...
#
# Source:   https://github.com/jamieden/dsame3  (file: defs.py)
# Commit:   61b3c5e630cf5c80eb6eab56e28e8fcffaff2f5a
# Licence:  ISC — see license.txt beside this file. Copyright (c) 2016
#           Joseph W. Metcalf; dsame3 is James Kitchens' 2023 fork of
#           Metcalf's original cuppa-joe/dsame.
#
# ONLY this file is taken from dsame3, and it is otherwise unmodified (this
# header is the sole addition). The rest of dsame3 CANNOT be vendored: dsame.py
# imports tqdm, sounddevice, soundfile, numpy and faster_whisper at module top
# level to serve --transcribe, and faster_whisper pulls CTranslate2 — hundreds
# of megabytes, no armhf wheels. On a 2 GB Pi 3 that is a wall, not a cost.
#
# We use the DATA here (US_SAME_CODE, US_SAME_AREA, SAME__EEE, SAME__ORG) and
# supply our own parser in services/nwr/common/same.py.
# ─────────────────────────────────────────────────────────────────────────────
VERSION = '0.3.2.0'
PROGRAM = 'dsame'
